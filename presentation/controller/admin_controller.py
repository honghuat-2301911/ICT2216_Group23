...
def admin_required(func):
    ...
    def admin_check(*args, **kwargs):
        ...
        return func(*args, **kwargs)  # Call the original function if authenticated as admin
...
def bulletin_page():
    ...
    if not result:
        return render_template("admin/bulletin.html", bulletin_list=[], error="No activities found.")
...
def delete_activity():
    ...
    success = remove_sports_activity(activity_id) # <-- Double-check which delete_activity this refers to
    if success:
